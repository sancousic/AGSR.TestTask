...
{
    public class DateLessOrEqualPeriodInfoBuilder<TEntity> : BasePredicateBuilder<TEntity, PeriodInfo>
        where TEntity: class, IEntity
    {
        public DateLessOrEqualPeriodInfoBuilder(Func<TEntity, PeriodInfo> getDataFunc)
            : base(getDataFunc)
        {
        }

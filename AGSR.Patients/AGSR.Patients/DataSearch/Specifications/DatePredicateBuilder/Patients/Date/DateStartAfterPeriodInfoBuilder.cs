...
{
    public class DateStartAfterPeriodInfoBuilder : SpecificationBase<Patient, PeriodInfo>
    {
        public DateStartAfterPeriodInfoBuilder(PeriodInfo data) : base(data)
        {
        }

        public override Expression<Func<Patient, bool>> ToExpressions() =>
            patient => patient.BirthDate >= Data.EndDate.Date;
    }
}

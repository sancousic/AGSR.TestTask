namespace AGSR.Patients.Constants
{
    public static class DateTimeFormats
    {
        ...
        public const string MilisecondFormat = "yyyy-MM-ddTHH:mm:ss.ff";
        ...
        public static string[] AllSupportedFormats = SupportedFormats.Concat(SupportedFormats.Select(x => x + "zzz")).ToArray();
    }
}

...
public class PatientController : ApiControllerBase
{
    ...
    private readonly IDataSearchModelBuilder<PeriodInfo> _searchModelBuilder;

    public PatientController(
        IPatientService patientService,
        IDataSearchModelBuilder<PeriodInfo> searchModelBuilder)
    {
    ...
    public async Task<ActionResult<IEnumerable<PatientModel>>> SearchPatient(
        ...
        => await ValidateRequest(
            ...
            async (r) =>
            {
                ...
                {
                    var model = _searchModelBuilder.Build(x);

                    return model;
                });

                var patients = _patientService.SearchPatientsByDate(dateSearchModels);
    ...
    /// </summary>
    /// <param name="patient">The instance of <see cref="PatientModel"/> class.</param>
    /// <returns>A single instance of updated patient model with the content.</returns>
    ...
    {
        var isPatientExists = await _patientService.IsPatientExists(patient.Name.Id);
